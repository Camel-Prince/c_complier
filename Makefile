scanner_parser_test: scanner.l parser.y ./abstract_syntax_tree/AstNode.cpp ./symbol_table/symbol.cpp
					...
					g++ -o scanner_parser_test AstNode.o symbol.o parser.tab.c scanner.lex.c
clean:
